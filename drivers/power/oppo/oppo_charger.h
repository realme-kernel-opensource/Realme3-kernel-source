...
typedef enum {
        OVERCHG_TEMP_STATUS__NORMAL = 0,                      /*<=35c*/
        OVERCHG_TEMP_STATUS__WARM,                         	  /*>35 && <=40C*/
        OVERCHG_TEMP_STATUS__HIGH,                            /*>40C*/
}
OPPO_CHG_OVERCHG_TEMP_STATUS;
...
struct oppo_chg_limits {
		...
		int non_normal_vterm_hw_inc;
      	...
      	int overchg_temp_high_decidegc;                /*>=40C*/
		int overchg_warm_fastchg_ma;					/*35~40C,750ma	*/
        int overchg_temp_warm_decidegc;                /*35C*/
		int overchg_normal_fastchg_ma;					/*<=35C,700ma*/

		int overchg_normal_vfloat_sw_limit;				//4.45V
		int overchg_temp_normal_vfloat_mv;				//4.5v
		int overchg_normal_vfloat_over_sw_limit;		//4.5V
...
/*        struct battery_data battery_main        */
        ...
        int                 enable_shipmode;
        int                 dod0_counts;
		bool				fastchg_to_overchg;
		int 				overchg_temp_status;
