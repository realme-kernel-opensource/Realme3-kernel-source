...
#endif
			bm_err("dts---00-pro=%d,=%d,=%d,=%d,=%d\n",fg_table_cust_data.fg_profile[0].fg_profile[0].mah,fg_table_cust_data.fg_profile[0].fg_profile[0].percentage,fg_table_cust_data.fg_profile[0].fg_profile[0].resistance,fg_table_cust_data.fg_profile[0].fg_profile[0].resistance2,fg_table_cust_data.fg_profile[0].fg_profile[0].voltage);
			break;
...
/* tongfeng.huang@EXP.BSP.CHG.basic, 2018/01/24, Remove for charge driver */
            ...
            #ifndef VENDOR_EDIT
            /*Jun.Wei@RM.BSP.CHG.Basic, 2018/11/15, donot power off when battery plug out*/
			kernel_power_off();
            #endif /* VENDOR_EDIT */
		}
	}
...
/* ChaoYing.Chen@EXP.BSP.CHG.basic, 2017/06/05, Remove for charge driver */
	...
	case FG_DAEMON_CMD_SET_RTC_UI_SOC:
	{
		...
		/*Jun.Wei@RM.BSP.CHG.Basic, 2019/01/16, record oppo uisoc*/
		#ifndef VENDOR_EDIT
