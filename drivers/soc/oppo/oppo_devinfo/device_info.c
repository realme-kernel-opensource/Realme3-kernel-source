...
static int pa_verify(void)
{
	struct manufacture_info pa_info;

	return 0;	//lfc add because not use it now
	...
	return register_device_proc("pa", pa_info.version, pa_info.manufacture);
}
...
#ifdef ODM_HQ_EDIT
        if (is_project(OPPO_17065) || is_project(OPPO_18611) ) {
                return -1;
        }
...
static int subboard_verify(struct devinfo_data *const devinfo_data)
{
	...
	switch(get_project()) {
		case OPPO_17197:
			...
			break;
		case OPPO_18531:
			if ((id1 == 1) && (id2 == 1) && (operator == OPERATOR_18531_ASIA || operator == OPERATOR_18531_ASIA_SIMPLE)) {
				snprintf(devinfo_data->sub_mainboard_info.manufacture, INFO_BUF_LEN, "rf-match");
			} else if ((id1 == 1) && (id2 == 0) && (operator == OPERATOR_18531_All_BAND)) {
				snprintf(devinfo_data->sub_mainboard_info.manufacture, INFO_BUF_LEN, "rf-match");
			} else {
				snprintf(devinfo_data->sub_mainboard_info.manufacture, INFO_BUF_LEN, "rf-unmatch");
			}
		...
		case OPPO_18601:
			if ((id1 == 1) && ((operator == OPERATOR_18601_REALME_INDIA) || (operator == OPERATOR_18601_REALME_INDIA_P70))) {
				snprintf(devinfo_data->sub_mainboard_info.manufacture, INFO_BUF_LEN, "rf-match");
