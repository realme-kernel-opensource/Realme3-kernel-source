...
#define AF_DRVNAME "DW9714AF_TS_DRV"
...
{
    int ret = 0;
    printk("guoameng-the value of holitech af position=%ld\n",a_u4Position);
...
/* ////////////////////////////////////////////////////////////// */
long DW9714AF_TS_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
    long i4RetValue = 0;
...
int DW9714AF_TS_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
    LOG_INF("Start\n");
...
int DW9714AF_TS_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
