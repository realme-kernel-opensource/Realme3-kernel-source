...
#define AF_DRVNAME "DW9714AF_QT_DRV"
...
#ifdef VENDOR_EDIT
/*dingpeifei@HQ 20181122 add for 1644748 dw9714*/
...
/* ////////////////////////////////////////////////////////////// */
long DW9714AF_QT_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
    long i4RetValue = 0;
...
int DW9714AF_QT_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
    LOG_INF("Start\n");
    ...
    if (*g_pAF_Opened == 2) {
        LOG_INF("Wait\n");
#ifdef VENDOR_EDIT
        /*dingpeifei@HQ 20181122 modify for update dw9714 qt driver*/
...
int DW9714AF_QT_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
