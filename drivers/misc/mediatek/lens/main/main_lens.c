...
static struct stAF_DrvList g_stAF_DrvList[MAX_NUM_OF_LENS] = {
	...
	{1, AFDRV_DW9714AF_QT, DW9714AF_QT_SetI2Cclient, DW9714AF_QT_Ioctl, DW9714AF_QT_Release, NULL},
	{1, AFDRV_DW9714AF_TS, DW9714AF_TS_SetI2Cclient, DW9714AF_TS_Ioctl, DW9714AF_TS_Release, NULL},
...
//wangzezhi@ODM.Multimedia.Camera 2018/10/09 camera bring up
				else if(strncmp(CONFIG_ARCH_MTK_PROJECT, "oppo6771_18601", 14) == 0)
					regVCAMAF = regulator_get(lens_device, "vldo28");
