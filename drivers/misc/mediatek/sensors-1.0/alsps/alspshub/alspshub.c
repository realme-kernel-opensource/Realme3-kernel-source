...
static ssize_t alspshub_show_ps_crosstalk(struct device_driver *ddri, char *buf)
{
	int offset[6] = {0};
	get_sensor_parameter(ID_PROXIMITY, offset);
...
static ssize_t alspshub_show_ps_delta(struct device_driver *ddri, char *buf)
{
	int offset[6] = {0};
	get_sensor_parameter(ID_PROXIMITY, offset);
...
static DRIVER_ATTR(offset, S_IWUSR | S_IRUGO, alspshub_show_ps_offset,  NULL );
static DRIVER_ATTR(crosstalk, S_IWUSR | S_IRUGO, alspshub_show_ps_crosstalk, NULL);
static DRIVER_ATTR(delta, S_IWUSR | S_IRUGO, alspshub_show_ps_delta, NULL );
static DRIVER_ATTR(als_cali, S_IWUSR | S_IRUGO, alspshub_show_als_cali, NULL );
#endif /* VENDOR_EDIT */
