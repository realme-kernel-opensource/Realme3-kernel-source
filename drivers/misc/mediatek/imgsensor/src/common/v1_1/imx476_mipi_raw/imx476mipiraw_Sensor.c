...
/*Feng.Hu@Camera.Driver 20171230 add for imx476 0.9cut and 0.91cut*/
#define IMX476_VER_90CUT 0x01
#define IMX476_VER_91CUT 0x02
static int32_t gSensorVersion = 0;
#define IMX476_REAL_CHIP_ID 0x476
#endif
...
/*Yijun.Tan @Camera.Driver modify for resolve startpreview slow 20180221*/
#define LSC_DEBUG 0
...
#ifdef VENDOR_EDIT
/*Feng.Hu@Camera.Driver 20171223 add for sensor otp id*/
#define MODULE_ID_OFFSET 0x0000
#define SENSOR_OTP_ID_OFFSET 0x0006
#define EEPROM_READ_ID  0xA2
#define IMX476_OTP_ID        0x51
static kal_uint16 read_otp_sensor_id(void)
{
	kal_uint16 get_byte = 0;
	char pusendcmd[2] = {(char)(SENSOR_OTP_ID_OFFSET >> 8), (char)(SENSOR_OTP_ID_OFFSET & 0xFF) };
...
#ifdef VENDOR_EDIT
/*CaoHua.Lin@Camera.Drive 20180124 write AWB gain to sensor*/
...
#ifdef VENDOR_EDIT
/*Feng.Hu@Camera.Driver 20180104 add for 0.90cut use 0.91 setting*/
...
static void preview_setting(void)
{
	...
	write_cmos_sensor_8(0x3F81, 0x2C);
	write_cmos_sensor_8(0x3FFC, 0x01);
	write_cmos_sensor_8(0x3FFD, 0x2C);
	write_cmos_sensor_8(0x0202, 0x07);
	write_cmos_sensor_8(0x0203, 0xD0);
	write_cmos_sensor_8(0x0224, 0x01);
	write_cmos_sensor_8(0x0225, 0xF4);
...
#ifdef VENDOR_EDIT
/*Feng.Hu@Camera.Driver 20171223 add for read real sensor chip id*/
static kal_uint32 return_lot_id_from_otp(void)
{
	kal_uint8 otp_sensor_id = 0;
	UINT32   sensor_chip_id = 0;

	sensor_chip_id = ((read_cmos_sensor_8(0x0016) << 8) | read_cmos_sensor_8(0x0017));
	if (sensor_chip_id == 0x550) {
		otp_sensor_id = read_otp_sensor_id();
		if (otp_sensor_id == IMX476_OTP_ID) {
			gSensorVersion = IMX476_VER_90CUT;
			LOG_INF("This is 0.90cut version\n");
			return IMX476_SENSOR_ID;
		}
	} else if (sensor_chip_id == IMX476_REAL_CHIP_ID) {
			gSensorVersion = IMX476_VER_91CUT;
			...
			*sensor_id = return_lot_id_from_otp();
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				if(deviceInfo_register_value == 0x00){
					register_imgsensor_deviceinfo("Cam_f", DEVICE_VERSION_IMX476, imgsensor_info.module_id);
					deviceInfo_register_value = 0x01;
				}
				#endif
				LOG_INF("IMX476_module_id=%d\n", imgsensor_info.module_id);
				return ERROR_NONE;
			}
...
static kal_uint32 open(void)
{
	...
	#ifdef VENDOR_EDIT
	/*Feng.Hu@Camera.Driver 20180104 add for 0.90cut use 0.91 setting*/
	if (gSensorVersion == IMX476_VER_90CUT) {
...
static kal_uint32 imx476_awb_gain(SET_SENSOR_AWB_GAIN *pSetSensorAWB)
{
							 ...
							 UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_SET_AWB_GAIN:
		#ifdef VENDOR_EDIT
		/*Feng.Hu@Camera.Driver 20180131 modify to seperate 3hdr and remosaic*/
		if (imgsensor.sensor_mode == IMGSENSOR_MODE_CAPTURE) {
			/*CaoHua.Lin@Camera.Drive 20180124 write AWB gain to sensor*/
			feedback_awbgain((UINT32)*(feature_data_32 + 1), (UINT32)*(feature_data_32 + 2));
		} else {
			imx476_awb_gain((SET_SENSOR_AWB_GAIN *) feature_para);
		}
		#endif
		break;
...
/* kin0603 */
UINT32 IMX476_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
