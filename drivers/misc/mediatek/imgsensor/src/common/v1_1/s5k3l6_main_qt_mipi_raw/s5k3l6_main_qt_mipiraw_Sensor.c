...
#define PFX "S5K3l6_main_qt_camera_sensor"
...
#include "s5k3l6_main_qt_mipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
        .sensor_id = S5K3L6_MAIN_QT_SENSOR_ID,
        ...
        while (imgsensor_info.i2c_addr_table[i] != 0xff) {
                ...
                do {
                        *sensor_id = ((read_cmos_sensor_8(0x0000) << 8) | read_cmos_sensor_8(0x0001)) ;
                        pr_err("s5k3l6_main_qt_sensor_id:0x%x==0x%x",*sensor_id,imgsensor_info.sensor_id);
...
UINT32 S5K3L6_MAIN_QT_MIPI_RAW_SensorInit(
