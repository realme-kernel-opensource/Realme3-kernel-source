...
#define PFX "S5K3l6_main_ts_camera_sensor"
...
#include "s5k3l6_main_ts_mipiraw_Sensor.h"
...
#define S5K3L6_MAIN_QT_EEPROM_CALI
#if MULTI_WRITE
...
static struct imgsensor_info_struct imgsensor_info = {
        .sensor_id = S5K3L6_MAIN_TS_SENSOR_ID,
...
static SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[7] = {
 ...
 {4208, 3120,  24,   0, 4160, 3120, 4160, 3120,   0,   0, 4160, 3120,   0, 0, 4160, 3120}, // 24fps dual camera at custom1
 {4208, 3120,  24,   0, 4160, 3120, 4160, 3120,   0,   0, 4160, 3120,   0, 0, 4160, 3120}, // 30fps dual camera at custom2
};
...
#ifdef S5K3L6_MAIN_QT_EEPROM_CALI
...
#ifndef VENDOR_EDIT
//dingpeifei@hq 20181222 del for log exp
...
#ifdef VENDOR_EDIT
//dingpeifei@hq 20181222 add for long exp
...
static void normal_video_setting(kal_uint16 currefps)
{
        ...
        /*Zezhi Wang@Cam.Driver modify for power reduce */
        table_write_cmos_sensor(addr_data_pair_pre_3l6,
                sizeof(addr_data_pair_pre_3l6) / sizeof(kal_uint16));
}
        ...
        while (imgsensor_info.i2c_addr_table[i] != 0xff) {
                ...
                do {
                        *sensor_id = ((read_cmos_sensor_8(0x0000) << 8) | read_cmos_sensor_8(0x0001)) + 1;
                        pr_err("s5k3l6_main_ts_sensor_id:0x%x",*sensor_id);
                        if (*sensor_id == imgsensor_info.sensor_id) {
                                hw_info_main_otp.sensor_name = SENSOR_DRVNAME_S5K3L6_MAIN_TS_MIPI_RAW;
                                //modify by zaki for third vendor module++++++++++
#ifdef S5K3L6_MAIN_QT_EEPROM_CALI
                                vendorId = read_eeprom(0x0000);
                                LOG_INF("zaki i2c write id: 0x%x, sensor id: 0x%x vendorID=0x%x\n",
...
UINT32 S5K3L6_MAIN_TS_MIPI_RAW_SensorInit(
