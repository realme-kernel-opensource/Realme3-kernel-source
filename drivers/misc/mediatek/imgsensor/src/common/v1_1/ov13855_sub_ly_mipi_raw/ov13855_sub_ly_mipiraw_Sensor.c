...
#define PFX "OV13855_sub_ly_camera_sensor"
...
#include "ov13855_sub_ly_mipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
        .sensor_id = OV13855_SUB_LY_SENSOR_ID,

        .checksum_value = 0x8b86a64,//test_Pattern_mode

        .pre = {
        .pclk = 108250560,        //record different mode's pclk
                .linelength =  2244,
                .framelength = 1608,
                .startx = 0,
                .starty = 0,
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_init_ov13855[] = {
        0x0300, 0x02,
        0x0301, 0x00,
        0x0302, 0x5a,
        0x0304, 0x00,
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_preview_ov13855[] = {
        0x0303, 0x01,
        0x3501, 0x40,
        0x3662, 0x10,
        0x3714, 0x28,
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_capture_15fps_ov13855[] = {
        0x0303, 0x00,
        0x3501, 0x80,
        0x3662, 0x12,
        0x3714, 0x24,
...
static kal_uint16 addr_data_pair_capture_30fps_ov13855[] = {
        0x0303, 0x00,
        0x3501, 0x80,
        0x3662, 0x12,
        0x3714, 0x24,
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_video_ov13855[] = {
        0x0303, 0x00,
        0x3501, 0x80,
        0x3662, 0x12,
        0x3714, 0x24,
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_hs_video_ov13855[] = {
        0x0303, 0x03,
        0x3501, 0x20,
        0x3662, 0x08,
        0x3714, 0x30,
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_slim_video_ov13855[] = {
        0x0303, 0x03,
        0x3501, 0x20,
        0x3662, 0x08,
        0x3714, 0x30,
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
        ...
        do {
                *sensor_id = return_sensor_id() + 1;
                pr_err("sensor_id:0x%x", *sensor_id);
        if (*sensor_id == imgsensor_info.sensor_id) {
                LOG_INF("i2c write id: 0x%x, sensor id: 0x%x\n",
                        imgsensor.i2c_write_id, *sensor_id);
                hw_info_sub_otp.sensor_name = SENSOR_DRVNAME_OV13855_SUB_LY_MIPI_RAW;
                return ERROR_NONE;
        }
                retry--;
        } while (retry > 0);
...
UINT32 OV13855_SUB_LY_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
