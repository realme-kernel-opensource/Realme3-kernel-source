...
#include "sp2509_hl_mipi_Sensor.h"

#include <linux/hardware_info.h> //For hardwareinfo
#define EEPROM_FM34C32_ID 0xAs0

/****************************Modify Following Strings for Debug****************************/
#define PFX "SP2509V_txd_camera_sensor"
#define LOG_1 LOG_INF("SP2509V_txd,MIPI 1LANE\n")
...
static imgsensor_info_struct imgsensor_info = {
        ...
        .custom1_delay_frame = 2,   // Dual camera setting
...
static SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[6]=
{
        ...
        {  1600, 1200,  0, 0, 1600, 1200, 1600, 1200, 0000, 0000, 1600, 1200,  0, 0, 1600, 1200}, //24fps for dual camera Custom1
}; // slim video
...
static void set_shutter(kal_uint16 shutter)
{
        ...
        if(shutter > 46080) shutter = 46080;
...
static void sensor_init(void)
{
...

        {
                ...
                write_cmos_sensor(0xfd,0x01);
                write_cmos_sensor(0xf0,0x40);//gb_suboffset
                write_cmos_sensor(0xf1,0x40);//blue_suboffset
                write_cmos_sensor(0xf2,0x40);//red_suboffset
                write_cmos_sensor(0xf3,0x40);//gr_suboffset
                write_cmos_sensor(0xf4,0x00);//shift_gb
                write_cmos_sensor(0xf5,0x00);//shift_blue
                write_cmos_sensor(0xf6,0x00);//shift_red
                ...
                do {
                        *sensor_id = return_sensor_id();
                        ...
                        if (*sensor_id == imgsensor_info.sensor_id) {
                                hw_info_main2_otp.sensor_name = SENSOR_DRVNAME_SP2509_HL_MIPI_RAW;
                                //zaki add ++++++++++++++
#if 0
                                ...
                                if(vendorId==0x58){
                                        //hw_info_main2_otp.sensor_name = SENSOR_DRVNAME_SP2509V_HLT_MIPI_RAW;
                                        return ERROR_NONE;

                                }else{
                                        pr_err("invalid vendorId!error vendorId=0x%x\n",vendorId);
...
UINT32 SP2509_HL_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
