 ...
 *
 ****************************************************************************/
#ifndef _GC2375_JK_MIPI_SENSOR_H
#define _GC2375_JK_MIPI_SENSOR_H

#define GC2375H_MIRROR_NORMAL
#undef GC2375H_MIRROR_H
#undef GC2375H_MIRROR_V
#undef GC2375H_MIRROR_HV
...
struct gc2375h_otp_data_str {
	kal_uint8 info_flag;	//Sunny:0x01
	kal_uint8 supplier_code;	//Sunny:0x01
	kal_uint8 module_code;		//AL1680:0x13
	...
	kal_uint8 info_checksum;
	kal_uint8 info_checksum_calc;
	kal_uint8 awb_flag;
	kal_uint8 R_over_G_unit_h;
	kal_uint8 R_over_G_unit_l;
	kal_uint8 B_over_G_unit_h;
	kal_uint8 B_over_G_unit_l;
	kal_uint8 Gb_over_Gr_unit_h;
	kal_uint8 Gb_over_Gr_unit_l;
	kal_uint8 R_over_G_golden_h;
	kal_uint8 R_over_G_golden_l;
	kal_uint8 B_over_G_golden_h;
	kal_uint8 B_over_G_golden_l;
	kal_uint8 Gb_over_Gr_golden_h;
	kal_uint8 Gb_over_Gr_golden_l;
	kal_uint8 awb_checksum;
	kal_uint8 awb_checksum_calc;
};
