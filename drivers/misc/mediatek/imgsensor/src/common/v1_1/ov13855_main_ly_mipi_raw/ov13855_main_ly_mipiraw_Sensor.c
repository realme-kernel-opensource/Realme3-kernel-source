...
#define PFX "OV13855_main_ly_camera_sensor"
...
#include "ov13855_main_ly_mipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
        .sensor_id = OV13855_MAIN_LY_SENSOR_ID,
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
        ...
        if (*sensor_id == imgsensor_info.sensor_id) {
                hw_info_main_otp.sensor_name = SENSOR_DRVNAME_OV13855_MAIN_LY_MIPI_RAW;
...
UINT32 OV13855_MAIN_LY_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
