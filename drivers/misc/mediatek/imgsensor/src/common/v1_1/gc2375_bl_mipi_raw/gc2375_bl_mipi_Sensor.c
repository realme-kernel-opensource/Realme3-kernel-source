...
#include "gc2375_bl_mipi_Sensor.h"

#include <linux/hardware_info.h> //For hardwareinfo

/****************************Modify Following Strings for Debug****************************/
#define PFX "gc2375_bl_camera_sensor"
...
static imgsensor_info_struct imgsensor_info = {
        .sensor_id = GC2375_BL_SENSOR_ID,                //record sensor id defined in Kd_imgsensor.h
        ...
        while (imgsensor_info.i2c_addr_table[i] != 0xff) {
                ...
                do {
                        *sensor_id = return_sensor_id();
                        LOG_DBG("gc2375H_sensor_id:0x%x",*sensor_id);
                        if (*sensor_id == imgsensor_info.sensor_id) {
                                hw_info_main2_otp.sensor_name = SENSOR_DRVNAME_GC2375_BL_MIPI_RAW;
...
UINT32 GC2375_BL_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
