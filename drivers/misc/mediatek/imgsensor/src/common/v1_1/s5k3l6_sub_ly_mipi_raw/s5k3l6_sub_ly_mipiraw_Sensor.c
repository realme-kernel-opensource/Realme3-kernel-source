...
#define PFX "S5K3l6_sub_ly_camera_sensor"
...
#include "s5k3l6_sub_ly_mipiraw_Sensor.h"

#include <linux/hardware_info.h> //For hardwareinfo

#define MULTI_WRITE 1

#define EEPROM_SUB3L6TS_ID 0xA4
#define S5K3L6_SUB_EEPROM_CALI
#if MULTI_WRITE
...
static struct imgsensor_info_struct imgsensor_info = {
        .sensor_id = S5K3L6_SUB_LY_SENSOR_ID,
...
#ifdef S5K3L6_SUB_EEPROM_CALI
static kal_uint16 read_eeprom(kal_uint32 addr)
{
        kal_uint16 get_byte=0;

        char pu_send_cmd[2] = { (char)(addr >> 8), (char)(addr & 0xFF) };
        iReadRegI2C(pu_send_cmd, 2, (u8*)&get_byte, 1, EEPROM_SUB3L6TS_ID);
        ...
        while (imgsensor_info.i2c_addr_table[i] != 0xff) {
                ...
                do {
                        *sensor_id = ((read_cmos_sensor_8(0x0000) << 8) | read_cmos_sensor_8(0x0001)) + 3;
                        pr_err("s5k3l6_sub_ly_sensor_id:0x%x\n",*sensor_id);
                        if (*sensor_id == imgsensor_info.sensor_id) {
                                hw_info_sub_otp.sensor_name = SENSOR_DRVNAME_S5K3L6_SUB_LY_MIPI_RAW;
...
UINT32 S5K3L6_SUB_LY_MIPI_RAW_SensorInit(
