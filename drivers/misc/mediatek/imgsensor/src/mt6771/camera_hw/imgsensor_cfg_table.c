...
struct IMGSENSOR_HW_CFG imgsensor_custom_config_for_17197[] = {
	{
		IMGSENSOR_SENSOR_IDX_MAIN,
		IMGSENSOR_I2C_DEV_0,
		{
...
struct IMGSENSOR_HW_CFG imgsensor_custom_config_for_18531[] = {
	{
		IMGSENSOR_SENSOR_IDX_MAIN,
		IMGSENSOR_I2C_DEV_0,
		{
...
struct IMGSENSOR_HW_CFG imgsensor_custom_config_for_18311[] = {
	{
		IMGSENSOR_SENSOR_IDX_MAIN,
		IMGSENSOR_I2C_DEV_0,
		{
...
#ifdef VENDOR_EDIT
/*Feng.Hu@Camera.Driver 20171121 add for power sequence*/
...
#endif
/*Caohua.Lin@Camera.Drv, 20180911 modify to add s5k3p9sp*/
...
//#ifdef ODM_HQ_EDIT
//wangzezhi@ODM.Multimedia.Camera 2018/10/09 camera bring up
//zaki add for oppo6771 +++
#if defined(S5K3L6_MAIN_QT_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5K3L6_MAIN_QT_MIPI_RAW,
		{
			{SensorMCLK, Vol_High, 0},
			{PDN, Vol_Low, 0},//No PDN Ctrl
			{RST, Vol_Low, 0},
			{DOVDD, Vol_1800, 0},
			{AVDD, Vol_High, 0},
			//wangzezhi@ODM_HQ.camera.driver change from 1.2V to 1.1V
			{DVDD, Vol_1100, 0},
			{AFVDD, Vol_2800, 2},
			{PDN, Vol_High, 0},
			{RST, Vol_High, 2},
...
#endif
#if defined(S5K3L6_MAIN_TS_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5K3L6_MAIN_TS_MIPI_RAW,
		{
			{SensorMCLK, Vol_High, 0},
			{PDN, Vol_Low, 0},//No PDN Ctrl
			{RST, Vol_Low, 0},
...
#endif
#if defined(OV13855_MAIN_LY_MIPI_RAW)
	{
		SENSOR_DRVNAME_OV13855_MAIN_LY_MIPI_RAW,
		{
			{SensorMCLK, Vol_High, 0},
			//{PDN, Vol_Low, 5},
			{RST, Vol_Low, 10},
...
#if defined(S5K3L6_SUB_QT_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5K3L6_SUB_QT_MIPI_RAW,
		{
			{SensorMCLK, Vol_High, 0},
			{PDN, Vol_Low, 0},//1.2V for DVDD
			{RST, Vol_Low, 0},
			{DOVDD, Vol_1800, 0},
			{AVDD, Vol_2800, 0},
			{DVDD, Vol_High, 0},
...
#endif
#if defined(S5K3L6_SUB_LY_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5K3L6_SUB_LY_MIPI_RAW,
		{
			{SensorMCLK, Vol_High, 0},
			{PDN, Vol_Low, 0},//1.2 for DVDD
			{RST, Vol_Low, 0},
			{DOVDD, Vol_1800, 0},
			{AVDD, Vol_2800, 0},
			{DVDD, Vol_High, 0},
...
#endif
#if defined(OV13855_SUB_LY_MIPI_RAW)
	{
		SENSOR_DRVNAME_OV13855_SUB_LY_MIPI_RAW,
		{
			{SensorMCLK, Vol_High, 0},
			{PDN, Vol_Low, 5},/* LDO:1.2v*/
			{RST, Vol_Low, 10},
			{RST, Vol_Low, 5},
			{AVDD, Vol_2800, 5},
			{DOVDD, Vol_1800, 5},
...
#if defined(GC2375_JK_MIPI_RAW)
	{
		SENSOR_DRVNAME_GC2375_JK_MIPI_RAW,
		{
			{PDN, Vol_High, 0},
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 1},
			//{DVDD, Vol_1800, 1},//Use The Same regulator with DOVDD
			{AVDD, Vol_2800, 1},
			{SensorMCLK, Vol_High, 0},
			{PDN, Vol_Low, 0, Vol_High},
...
#endif
#if defined(GC2375_BL_MIPI_RAW)
	{
		SENSOR_DRVNAME_GC2375_BL_MIPI_RAW,
		{
			//{PDN, Vol_Low, 0},//No PDN Ctrl
			{RST, Vol_Low, 0},
			{DOVDD, Vol_1800, 1},
...
#endif
#if defined(SP2509_HL_MIPI_RAW)
	{
		SENSOR_DRVNAME_SP2509_HL_MIPI_RAW,
		{
			{RST, Vol_Low, 0},
			{PDN, Vol_Low, 0},
			{PDN, Vol_High, 0},
			...
			//{DVDD, Vol_1200, 0},//Use The Same regulator with DOVDD
...
/*Yongzhi.Wang@RM.Camera add the driver of sensor,20190202*/
...
#if defined(GC2375H_MIPI_RAW)
	{
		SENSOR_DRVNAME_GC2375H_MIPI_RAW,
		{
			{RST, Vol_Low, 2},
			{PDN, Vol_High, 2},
			{DOVDD, Vol_1800, 1, Vol_Low, 0},
			{AVDD, Vol_2800, 1, Vol_Low, 0},
			{SensorMCLK, Vol_High, 0, Vol_Low, 0},
			{PDN, Vol_Low, 5, Vol_High, 1},
			{RST, Vol_High, 10, Vol_Low, 1},
			{PDN, Vol_Low, 5, Vol_High, 1},
		},
