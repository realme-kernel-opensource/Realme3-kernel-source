...
static int aw3642_enable(void)
{
	...
	mdelay(10);
	temp1 = aw3642_read_reg(aw3642_i2c_client, 0x0A);
	temp2 = aw3642_read_reg(aw3642_i2c_client, 0x0B);
	return ret;
	#else
...
static int aw3642_disable(void)
{
	...
	/*Yijun.Tan@Camera add for reset flag register 20171223*/
	mdelay(10);
	temp1 = aw3642_read_reg(aw3642_i2c_client, 0x0B);
	pr_err(" aw3642_disable_ch1 line=%d, flags value is 0x%x\n", __LINE__, temp1);
	#endif
