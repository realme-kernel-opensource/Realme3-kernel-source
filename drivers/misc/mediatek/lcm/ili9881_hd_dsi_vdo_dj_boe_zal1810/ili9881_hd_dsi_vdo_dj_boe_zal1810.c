 ...
 ** ODM_HQ_EDIT
 ** File: ili9881_hd_dsi_vdo_dj_boe_zal1810.c
 ...
 **  1.0           2018/10/21   Liyan@ODM_HQ   Source file for LCD driver
 ********************************************/
...
static struct LCM_setting_table init_setting_vdo[] = {
    ...
    {0xE0,27,{0x00,0x24,0x42,0x5F,0x88,0x50,0xB1,0xD3,0x00,0x27,0x95,0x69,0xA1,0xD5,0x08,0xAA,0x3D,0x7B,0xA2,0xD2,0xFE,0xFA,0x2C,0x68,0x9A,0x03,0xEC}}, 	  //auto 4 gamma2.3
    {0xE1,27,{0x00,0x24,0x42,0x5F,0x88,0x50,0xB1,0xD3,0x00,0x27,0x95,0x69,0xA1,0xD5,0x08,0xAA,0x3D,0x7B,0xA2,0xD2,0xFE,0xFA,0x2C,0x68,0x9A,0x03,0xEC}},
...
#endif
#ifndef BUILD_LK
    register_device_proc("lcd", "ili9881_dj", "txd vdo mode");
#endif
}
...
//bias end
    ...
    LCM_LOGI("%s,dj_ili9881c_id=0x%08x,version_id=0x%x\n",__func__, id, version_id);
    printf("%s,dj_ili9881c_id=0x%08x,version_id=0x%x\n",__func__, id, version_id);// id=0x00000098,version_id=0x81
    push_table(NULL,
        switch_table_page0,
...
{
    printk("%s,dj_ili9881c backlight: level = %d\n", __func__, level);
...
LCM_DRIVER ili9881_hd_dsi_vdo_dj_boe_zal1810_lcm_drv = {
    .name = "ili9881_dj_boe",
