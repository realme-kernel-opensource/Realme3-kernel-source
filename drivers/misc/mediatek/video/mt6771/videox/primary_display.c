...
#define FFL_END_LEVEL ((LED_FULL) * 40 / 100)
#define FFL_UPRATE (4)
...
#ifdef VENDOR_EDIT
/* YongPeng.Yi@PSW.MM.Display.LCD.Stability, 2019/01/14, bugid:1783435 add for fix douyu underflow issue */
...
//#ifdef ODM_HQ_EDIT
/* fanxiongnan@ODM.HQ.Multimedia.LCD 2018/10/31 added for ilitek bias voltage customization */
...
//#ifdef ODM_HQ_EDIT
/* fanxiongnan@ODM.HQ.Multimedia.LCM 2018/10/27
 * Check if need lcm bias_on&hw_reset before mipi dsi goes to LP11 */
