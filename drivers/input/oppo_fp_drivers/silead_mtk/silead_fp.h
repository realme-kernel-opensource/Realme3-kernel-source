...
#define SIFP_IOC_CHARGE_STATE _IOR(SIFP_IOC_MAGIC, 31, uint8_t)
...
#define TURN_ON_CHARGE_FUC //open charging state image optic func 

//#define PROC_DIR		"fp"      /* if defined, create node under /proc/fp/xxx */
//#define PROC_NODE		"fp_id_silead"   /* proc node name */
